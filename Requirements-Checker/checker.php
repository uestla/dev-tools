...
$tests[] = array(
	'title' => 'PHP version',
	'required' => TRUE,
	'passed' => version_compare(PHP_VERSION, $version = /**/'5.3.1'/**//*5.2*'5.2.0'*/, '>='),
	'message' => PHP_VERSION,
	'description' => "Your PHP version is too old. Nette Framework requires at least PHP $version or higher.",
);
